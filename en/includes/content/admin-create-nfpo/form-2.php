<?php
  ...
  if(empty($_POST) === false)
  {
    ...
    if(empty($errors) === true)
    {
      ...
      {
        $errors[] = 'That Organization name is already registered.';
      }
...
if($success === true)
{
  echo '<center><font color="green"><p>Organization Created!</p></font>';
}
?>
      ...
      <form class="login-form" enctype="multipart/form-data" action="" method="POST">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              <input class="w-input" name="username" type="text" value="<?php print_r($_POST['username']); ?>" placeholder="Enter Account Username">
            </td>
          </tr>
          ...
          <tr>
            ...
            <td>
              <input class="w-input" name="organization-name" type="text" value="<?php print_r($_POST['organization-name']); ?>" placeholder="Enter Organization Name">
            </td>
          </tr>
          ...
          <tr>
            ...
            <td>
              <textarea class="w-input" name="physical-address" rows="2" placeholder="Enter Physical Address"><?php print_r($_POST['physical-address']); ?></textarea>
            </td>
          </tr>
          ...
          <tr>
            ...
            <td>
              <textarea class="w-input" name="postal-address" rows="2" placeholder="Enter Postal Address"><?php print_r($_POST['postal-address']); ?></textarea>
            </td>
          </tr>
          ...
          <tr>
            ...
            <td>
              <input class="w-input" name="zip" type="text" value="<?php if( empty($_POST) === true ) {print_r($fetched_data['zip']);} else{print_r($_POST['zip']);} ?>" placeholder="Enter ZipCode">
            </td>
          </tr>
