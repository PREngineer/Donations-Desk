    ...
    <form class="login-form" enctype="multipart/form-data" action="" method="POST">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            <input class="w-input" name="contact-first" type="text" value="<?php if( empty($_POST) === true ) print_r($fetched_data['contact-first']); else print_r($_POST['contact-first']); ?>" placeholder="John">
          </td>
        </tr>
        ...
        <tr>
          ...
          <td>
            <input class="w-input" name="contact-last" type="text" value="<?php if( empty($_POST) === true ) print_r($fetched_data['contact-last']); else print_r($_POST['contact-last']); ?>" placeholder="Doe">
          </td>
        </tr>
        ...
        <tr>
          <th>Contact Email [*]</th>
          <td>
            <input class="w-input" name="contact-email" type="text" value="<?php if( empty($_POST) === true ) print_r($fetched_data['contact-email']); else print_r($_POST['contact-email']); ?>" placeholder="Enter that person's e-mail">
          </td>
        </tr>
      </tbody>
