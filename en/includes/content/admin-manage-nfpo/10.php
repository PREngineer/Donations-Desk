<?php
  ...
  */
  $fetched_data = admin_nfpo_data($_GET['id'], 'username', 'federal-exemption');
  ...
  <form class="login-form" enctype="multipart/form-data" action="/donationsdesk/uploads/admin-upload-pdf.php" method="POST">
      ...
      <tr>
        <td colspan="2">
          ...
          <br><br>
          <iframe src="http://docs.google.com/gview?url=http://asesoresfinancierospr.org/<?php echo $fetched_data['federal-exemption']; ?>&embedded=true" style="width:700px; height:400px;" frameborder="0"></iframe>
          <br><br>
        </td>
      </tr>
