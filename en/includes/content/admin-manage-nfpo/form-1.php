  ...
  */
  ...
  if(empty($_POST) === false)
  {
    ...
    if(empty($errors) === true)
    {
      ...
      if( organization_exists($_POST['organization-name']) === true && $_POST['organization-name'] != $current_data['organization-name'] )
      {
...
if($success === true)
{
  echo '<center><font color="green"><p>Changes were saved!</p></font>';
}
  ...
  <tbody>
      ...
      <form class="login-form" enctype="multipart/form-data" action="" method="POST">
        ...
        <tbody>
          ...
          <tr>
            <th class="required">Account Username [*]</th>
            <td>
              <input class="w-input" name="username" type="text" value="<?php if( empty($_POST) === true ) 
              print_r($current_data['username']); else print_r($_POST['username']); ?>" placeholder="Enter Account Username">
            </td>
          </tr>
          ...
          {
            echo '<input type="radio" name="active" checked value="1">Active';
          }
          else
          {
          ...
          {
            echo '<input type="radio" name="active" checked value="0">Inactive';
          }
          else
          {
              echo '<input type="radio" name="active" value="0">Inactive';
          }
          ?>
          <br>
            </td>
          ...
          <tr>
            ...
            <td>
              ...
              print_r($current_data['organization-name']); else print_r($_POST['organization-name']); ?>" placeholder="Enter Organization Name">
            </td>
          </tr>
          ...
          <tr>
            ...
            <td>
              <textarea class="w-input" name="physical-address" rows="2" placeholder="Enter Physical Address"><?php if( empty($_POST) === true ) 
          ...
          <tr>
            ...
            <td>
              <textarea class="w-input" name="postal-address" rows="2" placeholder="Enter Postal Address"><?php if( empty($_POST) === true ) 
          ...
          <tr>
            ...
            <td>
              <select name="municipality" size="1">
                <option value=""              <?php if( empty($_POST) === true ) {if ($current_data['municipality'] == '')             echo ' selected = "selected"';} else{if($_POST['municipality'] == '') echo ' selected = "selected"';} ?> >Select Municipality</option>
          ...
          <tr>
            <th>Zip Code [*]</th>
            <td>
              <input class="w-input" name="zip" type="text" value="<?php if( empty($_POST) === true ) {print_r($current_data['zip']);} else{print_r($_POST['zip']);} ?>" placeholder="Enter ZipCode">
            </td>
          </tr>
          ...
          <tr>
            <th>Employer Social Security Number [*]</th>
            <td>
