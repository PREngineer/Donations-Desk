...
$show = 1;
  ...
  if(empty($_POST) === false)
  {
    ...
    if(empty($errors) === true)
    {
      ...
      if(mysql_result(mysql_query("SELECT COUNT(`email`) FROM `ratings` WHERE `id` = " . $_GET['id'] . " AND `email` = " . $_POST['email']), 0) > 0)
      {
        ...
        $errors[] = 'Sorry, you have already rated this organization.';
      }
  ...
  if(empty($_POST) === false && empty($errors) === true)
  {
    ...
    echo '<center><font color="green"><p>Thank you for Rating this Organization.</p></font>';

    echo '<center><font color="green"><p>You will be redirected to the Organization\'s page within 5 seconds.
    If it doesn\'t happen, <a href="nfpo-details.php?id=' . $_GET['id'] . '">Click Here!</a>.</p></font>';
...
?>
  ...
  <form class="login-form" enctype="multipart/form-data" action="" method="POST">
    ...
    <tr>
      <th class="required">Atmosphere: [*]</th>
      <td>
        <select name="r1">
        ...
        <tr>
      <th class="required">Attention: [*]</th>
      <td>
        <select name="r2">
      ...
      <td>
        ...
        <tr>
      <th class="required">Organization: [*]</th>
      <td>
        <select name="r5">
        ...
        <tr>
      <th class="required">Quality of Service: [*]</th>
      <td>
        <select name="r6">
        ...
        <tr>
      <th class="required">Quickness: [*]</th>
      <td>
        <select name="r7">
  ...
  <tbody>
    <tr>
      <td colspan="2" align="right">
       ...
       <input class="w-button" type="submit" value="Rate!">
      </td>
    </tr>
  </tbody>
