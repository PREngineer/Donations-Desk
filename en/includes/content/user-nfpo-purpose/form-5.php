  ...
  else if(empty($errors) === false)
  {
    ...
    if($success === true)
    {
      echo '<center><font color="green"><p>Changes were saved!</p>
            ...
            <p><a href="user-nfpo-social.php">By Clicking Here!</a></p></center>';
    }
?>
...
<tbody>
    ...
    <form class="login-form" enctype="multipart/form-data" action="" method="POST">
      ...
      <tbody>
        ...
        <tr>
          <th class="required">Vision [*]</th>
          <td>
            <textarea class="w-input" name="vision" rows="2" cols="40" placeholder="Enter your Vision"><?php if( empty($_POST) === true ) print_r($fetched_data['vision']); else print_r($_POST['vision']); ?></textarea>
          </td>
        </tr>
          
        <tr>
          <th class="required">Mission [*]</th>
          <td>
            <textarea class="w-input" name="mission" rows="2" cols="40" placeholder="Enter your Mission"><?php if( empty($_POST) === true ) print_r($fetched_data['mission']); else print_r($_POST['mission']); ?></textarea>
          </td>
        </tr>
        
        <tr>
          <th class="required">Services Provided [*]</th>
          <td>
            <textarea class="w-input" name="services" rows="2" cols="40" placeholder="List the services your Organization provides"><?php if( empty($_POST) === true ) print_r($fetched_data['services']); else print_r($_POST['services']); ?></textarea>
          </td>
        </tr>
        
        <tr>
          <th>Long Term Projections</th>
          <td>
            <textarea class="w-input" name="projections" rows="2" cols="40" placeholder="Enter Long Term Projections"><?php if( empty($_POST) === true ) print_r($fetched_data['projections']); else print_r($_POST['projections']); ?></textarea>
          </td>
        </tr>
              
        <tr>
          <th class="required">Target Population [*]</th>
          <td >
            <div class="block">
        ...
        <tr>
          <th class="required">Population Impact [*]</th>
          <td>
