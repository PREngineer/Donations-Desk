...
define("UPLOAD_DIR", "../uploads/logos/");
...
if (!empty($_FILES['file'])) 
{
    ...
    {
    	// Redirect with error
        header('Location: /donationsdesk/en/admin-manage-nfpo.php?e1=1&edit=6&id=' . $_POST['id'] . '&doc=' . $_POST['doc']);
    ...
    {
        // Redirect with error
        header('Location: /donationsdesk/en/admin-manage-nfpo.php?e2=1&edit=6&id=' . $_POST['id'] . '&doc=' . $_POST['doc']);
	...
	{
    	// Redirect with error
        header('Location: /donationsdesk/en/admin-manage-nfpo.php?e3=1&edit=6&id=' . $_POST['id'] . '&doc=' . $_POST['doc']);
    ...
    { 
        // Redirect with error
        header('Location: /donationsdesk/en/admin-manage-nfpo.php?e4=1&edit=6&id=' . $_POST['id'] . '&doc=' . $_POST['doc']);
    ...
    else
    {
        ...
        $path = '/donationsdesk/uploads/logos/' . $name;
        ...
        mysql_query("UPDATE `OSFL` SET `" . $field . "` = '" . $path . "' WHERE `id` = '" . $_POST['id'] . "'");

        // Set proper permissions on the new file
        chmod(UPLOAD_DIR . $name, 0644);

        // Redirect to Success Message
        $address = '/donationsdesk/en/admin-manage-nfpo.php?success=true&edit=6&id=' . $_POST['id'] . '&doc=' . $_POST['doc'];
