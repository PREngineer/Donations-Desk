...
if (!empty($_FILES['file'])) 
{
    ...
    {
        // Redirect with error
        header('Location: ../en/admin-manage-nfpo.php?e6=1&edit=6&id=' . $_POST['id'] . '&doc=' . $_POST['doc']);
    ...
    {
    	// Redirect with error
        header('Location: ../en/admin-manage-nfpo.php?e7=1&edit=6&id=' . $_POST['id'] . '&doc=' . $_POST['doc']);
    ...
    { 
        // Redirect with error
        header('Location: ../en/admin-manage-nfpo.php?e4=1&edit=6&id=' . $_POST['id'] . '&doc=' . $_POST['doc']);
