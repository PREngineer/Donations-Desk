...
foreach($_POST as $key=>$value)
{
  ...
  {
    // Redirect with error
    header('Location: ../en/admin-manage-campaign.php?edit=1&e4=1&id=' . $_POST['id'] . '&goal=' . $_POST['goal'] . '&info=' . $_POST['info'] . 
        '&end=' . $_POST['end'] . '&category=' . $_POST['category'] . '&paypal=' . $_POST['paypal']);
...
if(checkdate($m, $d, $y) == false)
{
    ...
    // Redirect with error
    header('Location: ../en/admin-manage-campaign.php?edit=1&e5=1&id=' . $_POST['id'] . '&goal=' . $_POST['goal'] . '&info=' . $_POST['info'] . 
        '&end=' . $_POST['end'] . '&category=' . $_POST['category'] . '&paypal=' . $_POST['paypal']);
...
{
    // Redirect with error
    header('Location: ../en/admin-manage-campaign.php?edit=1&e6=1&id=' . $_POST['id'] . '&goal=' . $_POST['goal'] . '&info=' . $_POST['info'] . 
        '&end=' . $_POST['end'] . '&category=' . $_POST['category'] . '&paypal=' . $_POST['paypal']);
...
if($_FILES['file']['error'] == 4)
{
    // Save Path to DB
        ...
        mysql_query("UPDATE `Campaigns` 
            SET `info`='$info', `end`='$end', `goal`='$goal', `category`='$category', `paypal`='$paypal' 
            WHERE `id` = $id");

        // Redirect to Success Message
        $address = '../en/admin-manage-campaign.php?edit=1&success=true&id=' . $_POST['id'] . '&goal=' . $_POST['goal'] . '&info=' . $_POST['info'] . 
        '&end=' . $_POST['end'] . '&category=' . $_POST['category'] . '&paypal=' . $_POST['paypal'];
...
else
{
    ...
    {
    	// Redirect with error
        header('Location: ../en/admin-manage-campaign.php?edit=1&e1=1&id=' . $_POST['id'] . '&goal=' . $_POST['goal'] . '&info=' . $_POST['info'] . 
        '&end=' . $_POST['end'] . '&category=' . $_POST['category'] . '&paypal=' . $_POST['paypal']);
	...
	{
    	// Redirect with error
        header('Location: ../en/admin-manage-campaign.php?edit=1&e2=1&id=' . $_POST['id'] . '&goal=' . $_POST['goal'] . '&info=' . $_POST['info'] . 
        '&end=' . $_POST['end'] . '&category=' . $_POST['category'] . '&paypal=' . $_POST['paypal']);
    ...
    { 
        // Redirect with error
        header('Location: ../en/admin-manage-campaign.php?edit=1&e3=1&id=' . $_POST['id'] . '&goal=' . $_POST['goal'] . '&info=' . $_POST['info'] . 
        '&end=' . $_POST['end'] . '&category=' . $_POST['category'] . '&paypal=' . $_POST['paypal']);
    ...
    else
    {
        ...
        // Actual MySQL Query that Updates the information
        mysql_query("UPDATE `Campaigns` 
            SET `info`='$info', `end`='$end', `goal`='$goal', `category`='$category', `campaign-logo`='$path', `paypal`='$paypal' 
            WHERE `id` = '$id'");
