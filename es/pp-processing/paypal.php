...
switch ($_GET['action']) 
{
   ...
   {
      $p->add_field('item_name', 'Donations Desk - Donación Campaña');
   }
   ...
   case 'success':      // Order was successful...
      ...
      echo "
         <h3>Gracias por su donación.</h3>
         <br>
         Estará recibiendo un correo de confirmación de PayPal en poco tiempo.
         <br>
         Puede cerrar ésta ventana.
         <br><br>";
