<?php
  ...
  */
  $fetched_data = nfpo_data($user_data['username'], 'username', 'state-exemption');
...
<tbody>
  ...
  <form class="login-form" enctype="multipart/form-data" action="/donationsdesk/uploads/upload-pdf.php" method="POST">
      ...
      <tr>
        <td colspan="2">
          <h2>Documento de Exensión del Estado actual es:</h2>
          <br><br>
          <iframe src="http://docs.google.com/gview?url=http://webjmps.byethost16.com<?php echo $fetched_data['state-exemption']; ?>&embedded=true" style="width:700px; height:400px;" frameborder="0"></iframe>
          <br><br>
        </td>
      </tr>
