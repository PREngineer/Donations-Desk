...
echo 'Por favor espere en lo que sube el archivo.  Puede parecer que no responda, pero si está funcionando.<br>';
...
if($_GET['e1'] == '1')
{
  echo '<font color="red">Ocurrió un error al subir el Logo.  Por favor trate de nuevo.
        <br> Posibles errores:
        <br> Tamaño de Archivo excede límite (1MB)
...
if($_GET['e3'] == '1')
{
  echo '<font color="red">¡No se logró cargar!  Por favor intente de nuevo.</font>';
}
...
{
  echo '<center><font color="green"><p>¡Campaña actualizada!</p></font>';
}

// Invalid Date
if($_GET['e5'] == '1')
{
  echo '<font color="red">¡Formato de fecha inválido!  Por favor use el recomendado.</font>';
}
        ...
        <tbody>
          ...
          <tr>
            ...
            <div class="block">
              ...
              <input name="category[]" type="checkbox" value="Climate Change"     <?php if( in_array("Climate Change", $fetched_data['category']) ) { echo ' checked = "checked"'; } ?> >Cambio Climático
              <br>
              ...
              <input name="category[]" type="checkbox" value="Health"             <?php if( in_array("Health", $fetched_data['category']) ) { echo ' checked = "checked"'; } ?> >Saludo
