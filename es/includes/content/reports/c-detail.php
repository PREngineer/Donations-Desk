...
$output .= '
<b><u>Detalles de Transacciones de Campañas</u></b><br>
			...
			<center>
				<th colspan="7">'.$name.' - Campaign #'.$id.'</th>
			  	...
			  	<tr bgcolor="#000000">
					...
					<td width="200">
					<font color="#FFFFFF"><b>Nombre Donante</b></font>
					</td>
					<td width="200">
					<font color="#FFFFFF"><b>E-mail Donante</b></font>
					</td>
					<td width="200">
					<font color="#FFFFFF"><b>E-mail Recibe</b></font>
					</td>
				</tr>';
