  ...
  if(empty($_POST) === false)
  {
    ...
    if(empty($errors) === true)
    {
      ...
      if(checkdate($m, $d, $y) == false)
      {
        ...
        $errors[] = 'Formato de Fecha de Incorporación incorrecto, debe ser: yyyy-mm-dd';
      }
      ...
      {
        $errors[] = 'No se puede cambiar el nombre a uno que ya existe.';
      }
    }
...
if($success === true)
{
  echo '<center><font color="green"><p>¡Se guardaron los cambios!</p>
        <p>Continúe a la próxima información requerida: </p></font>
        <p><a href="user-nfpo-rep.php">Aquí!</a></p></center>
        ';
}
?>
  ...
  <tbody>
      ...
      <form class="login-form" enctype="multipart/form-data" action="" method="POST">
        ...
        <tbody>
          ...
          <tr>
            <th class="required">Seguro Social Patronal [*]</th>
            <td>
