...
<div>
  ...
  <div class="w-container">
    ...
    <div class="w-row title-section">
      ...
      <!-- Column #2 (1/3 page width) - Title of the page and description -->
      <div class="w-col w-col-6">
        <h1>Detalles</h1>
        <p class="subtitle-paragraph" align="justify">Aquí están los detalles para la Organización seleccionada.</p>
      </div>

      <!-- Column #3 (1/3 page width) -->
