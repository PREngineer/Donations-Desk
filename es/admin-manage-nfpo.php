...
<?php include 'includes/content/admin-manage-nfpo/section-1.php'; ?>

<!-- Include the Campaigns Section -->
<!-- This section has the display of all the NFPOs in the DB -->
<?php include 'includes/content/admin-manage-nfpo/section-2.php'; ?>
